  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative h-[60vh] min-h-[400px] w-full flex items-center justify-center text-white">
        <Image
          src="https://images.unsplash.com/photo-1521099238852-9e41d84a7544?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxtaW5pbmclMjBsYW5kc2NhcGV8ZW58MHx8fHwxNzU1NDI4MzM3fDA&ixlib=rb-4.1.0&q=80&w=1080"
